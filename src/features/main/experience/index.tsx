...
const Experience: React.FC = () => {
  return (
    <>
      <section className="py-[5rem] max-lg:py-[3rem] max-w-full relative bg-[#101013] pl-[10rem] max-lg:pl-[2rem] text-white pr-[12rem] max-lg:pr-[4rem]">
        <h2 className="text-3xl mb-4 font-bold">Experience</h2>
        <h3 className="text-3xl font-medium max-lg:text-2xl leading-[3rem] text-justify">
      ...
      <section className="h-fit py-16 max-lg:py-8 max-w-full relative bg-[#18181B] pl-[10rem] max-lg:pl-[2rem] text-white pr-[12rem] max-lg:pr-[4rem]">
        <h2 className="text-3xl mb-8 font-bold">Work Experience</h2>
