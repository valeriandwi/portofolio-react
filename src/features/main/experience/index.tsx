...
const Experience: React.FC = () => {
  return (
    <>
      <div className="py-[5rem] w-full relative bg-[#101013] pl-[10rem] max-lg:pl-[2rem] text-white pr-[12rem] max-lg:pr-[4rem]">
      ...
      <div className="h-fit py-8 w-full relative bg-[#18181B] pl-[10rem] max-lg:pl-[2rem] text-white pt-[5rem] pr-[12rem] max-lg:pr-[4rem]">
