  ...
  return (
    <div>
      ...
      <div className="max-w-screen h-fit">
        <div className="gradient-bg h-[150vh]">
          <div className="flex-col flex space-y-[60vh]">
            <section className="text-container justify-center pl-[10rem]">
              <h2 className="text-6xl">Hi, My Name is</h2>
              <h1 className="text-8xl font-bold">Valerian Dwi Purnomo</h1>
              <h3 className="text-2xl">Frontend Web Developer</h3>
            </section>
            <section className="text-container justify-center pl-[10rem] pr-[12rem]">
      ...
      <div className="h-fit py-[5rem] w-full relative bg-[#101013] pl-[10rem] text-white pr-[12rem]">
